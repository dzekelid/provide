...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/provide/master/_listings/square/apis.md
...
- name: Square Connect - Provides non-confidential details for all of a location's
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/provide/master/_listings/square/v1location-idbankaccounts-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/provide/master/_listings/square/v1location-idbankaccounts-get-openapi.md
- name: Square Connect - Provides non-confidential details for a merchant's associated
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/provide/master/_listings/square/v1location-idbankaccountsbank-account-id-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/provide/master/_listings/square/v1location-idbankaccountsbank-account-id-get-openapi.md
x-common:
- type: x-website
  url: http://square.com
- type: x-api-gallery
